...
- `MANIFEST.lock` and the manifest root hash cover `packages/`, `spec/`,
  `provisioning/`, `package.json` and `package-lock.json`, which is what
  `make print-manifest-roots` prints. This line
